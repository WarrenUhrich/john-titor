...
//     const millisecondsSinceMidnight = date.getUTCHours() * 3600000 + date.getUTCMinutes() * 60000 + date.getUTCSeconds() * 1000 + date.getUTCMilliseconds();
//     // Calculate the Swatch Internet time (beats) based on 1000 beats per day
//     const beats = Math.floor((millisecondsSinceMidnight / 86400000) * 1000) % 1000;
//     return String(beats);
//   },
